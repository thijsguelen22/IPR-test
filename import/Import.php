...
class Import
{
    ...
    */
    private function connect() {
        try {
            //$this->db = new PDO("sqlsrvl:host=".$this->host.";dbname=".$this->database, $this->username, $this->password);
            $this->db = new PDO("sqlsrv:Server=$this->host;Database=$this->database; ConnectionPooling=0", "$this->username", "$this->password");
